              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                {user ? (
                  <>
                    ...
                    >
                      <span className="absolute -right-1 -top-1 inline-flex items-center justify-center rounded-full bg-indigo-600 px-2 py-1 text-xs font-bold leading-none text-white">
                        {totalItems}
                      </span>
